...
void team() {
  ...
  cin >> toss;
  while (toss != 1 && toss != 2) {
    cout << "Invalid Choice! Please Enter choice by number (Press 1 or 2): ";
    cin >> toss;
  }
  ...
  cout << "Enter choice by number (Press 1 or 2): ";
  cin >> toss_choice;
  while (toss_choice != 1 && toss_choice != 2) {
    cout << "Invalid Choice! Please Enter choice by number (Press 1 or 2): ";
    cin >> toss_choice;
  }

  int opener, nonstriker, bowler;
  bool selected_batsman_innings1[team_size] = {false};
  if (toss == 1) {
    ...
    if (toss_choice == 1) {
      ...
      cout << "Select the Opening batsman of " << team_name[0]
           << " by number: ";
      cin >> opener;
      while (opener <= 0 || opener > team_size) {
        cout << "Invalid choice! Please select a player within the range (1 to "
             << team_size << "): ";
        cin >> opener;
      }

      selected_batsman_innings1[opener - 1] = true;
      cout << "Select the Non-Striker batsman of " << team_name[0]
           << " by number: ";
      cin >> nonstriker;
      while (nonstriker <= 0 || nonstriker > team_size) {
        cout << "Invalid choice! Please select a player within the range (1 to "
             << team_size << "): ";
        cin >> nonstriker;
      }
      selected_batsman_innings1[nonstriker - 1] = true;
      ...
      cin >> bowler;
      while (bowler <= 0 || bowler > team_size) {
        cout << "Invalid choice! Please select a bowler within the range (1 to "
             << team_size << "): ";
        cin >> bowler;
      }
    } else {
      ...
      cout << "Select the Opening batsman of " << team_name[1]
           << " by number: ";
      cin >> opener;
      while (opener <= 0 || opener > team_size) {
        cout << "Invalid choice! Please select a player within the range (1 to "
      ...
      selected_batsman_innings1[opener - 1] = true;
      cout << "Select the Non-Striker batsman of " << team_name[1]
           << " by number: ";
      cin >> nonstriker;
      while (nonstriker <= 0 || nonstriker > team_size) {
        cout << "Invalid choice! Please select a player within the range (1 to "
  ...
  for (int over = 1; over <= overs; over++) {
    ...
    for (int ball = 1; ball <= 6; ball++) {
      ...
      cout << "Ball " << ball
           << ": Enter what happened (0 = Dot ball, 1 = 1 run, 2 = 2 runs, 3 = "
              "3 runs, 4 = Four, 6 = Six, 7 = Wicket, 8 = No Ball, 9 = Wide): ";
      int event;
      cin >> event;

      total_balls_bowled++;

      bool dismissed[team_size] = {false};
      ...
      case 7:
        if (free_hit) {
          ...
          dismissed[opener - 1] = true;
          cout << "Wicket! "
               << (toss == 1
                       ? (toss_choice == 1 ? players_of_team_one[opener - 1]
                                           : players_of_team_two[opener - 1])
                       : (toss_choice == 1 ? players_of_team_two[opener - 1]
                                           : players_of_team_one[opener - 1]))
               << " is out." << endl;
          ...
          for (int i = 0; i < team_size; ++i) {
            ...
            if (toss == 1 && toss_choice == 1) {
              player_name = players_of_team_one[i];
            } else if (toss == 1 && toss_choice == 2) {
              player_name = players_of_team_two[i];
            ...
            if (batsman_balls[i] > 0) {
              cout << " - " << batsman_scores[i] << "(" << batsman_balls[i]
                   << ")";
              ...
              if (selected_batsman_innings1[i]) {
                cout << " - 0(0) ";
              } else {
                cout << " - Yet to bat";
              }
          ...
          bool valid = false;
          while (!valid) {
            cout << "Choose a new batsman (enter player number): ";
            cin >> new_batsman;

            if (new_batsman > 0 && new_batsman <= team_size &&
                !dismissed[new_batsman - 1]) {
              valid = true;
              dismissed[new_batsman - 1] = true;
              cout << "New batsman: "
                   << (toss == 1 ? (toss_choice == 1
                                        ? players_of_team_one[new_batsman - 1]
                                        : players_of_team_two[new_batsman - 1])
                                 : (toss_choice == 1
                                        ? players_of_team_two[new_batsman - 1]
                                        : players_of_team_one[new_batsman - 1]))
                   << endl;
              ...
              cout << "Invalid player choice! Please choose from available "
                      "players."
                   << endl;
            }
          }
      ...
      if (dot_balls_in_over == 6) {
        ...
        cout << "Maiden over bowled by "
             << (toss == 1 && toss_choice == 1
                     ? players_of_team_two[bowler - 1]
                     : (toss == 1 && toss_choice == 2
                            ? players_of_team_one[bowler - 1]
                            : (toss == 2 && toss_choice == 1
                                   ? players_of_team_one[bowler - 1]
                                   : players_of_team_two[bowler - 1])))
             << "!" << endl;
      }
      ...
      if (over != overs) {
        cout << "Current Score: " << score << "/" << wickets
             << " (Extras: " << extras << ") (Run Rate: " << run_rate << ")"
             << endl;
      }
      if (toss == 1 && toss_choice == 1) {
        cout << "Batsman " << players_of_team_one[opener - 1]
             << "*: " << batsman_scores[opener - 1] << " ("
             << batsman_balls[opener - 1] << " balls)" << endl;
        cout << "Bowler " << players_of_team_two[bowler - 1] << ": "
             << bowler_runs_conceded[bowler - 1] << " runs conceded in "
             << bowler_balls_bowled[bowler - 1] << " balls." << endl;
      } else if (toss == 1 && toss_choice == 2) {
        cout << "Batsman " << players_of_team_two[opener - 1]
             << "*: " << batsman_scores[opener - 1] << " ("
             << batsman_balls[opener - 1] << " balls)" << endl;
        cout << "Bowler " << players_of_team_one[bowler - 1] << ": "
             << bowler_runs_conceded[bowler - 1] << " runs conceded in "
             << bowler_balls_bowled[bowler - 1] << " balls." << endl;
      } else if (toss == 2 && toss_choice == 1) {
        cout << "Batsman " << players_of_team_two[opener - 1]
    ...
    if (wickets == (team_size - 1)) {
      ...
      for (int i = 0; i < team_size; i++) {
        ...
        double economy = (bowler_balls_bowled[i] > 0)
                             ? (static_cast<double>(bowler_runs_conceded[i]) /
                                (bowler_balls_bowled[i] / 6.0))
                             : 0.0;
        ...
        if (toss == 1 && toss_choice == 1) {
          cout << players_of_team_two[i] << ": " << bowler_runs_conceded[i]
               << " runs in " << overs_bowled << "." << balls_bowled
               << " overs "
               << "(Economy: " << economy
               << ", Maiden overs: " << bowler_maiden_overs[i]
               << ", Wickets: " << bowler_wickets_taken[i] << ")\n";
        }
        if (toss == 1 && toss_choice == 2) {
          cout << players_of_team_one[i] << ": " << bowler_runs_conceded[i]
               << " runs in " << overs_bowled << "." << balls_bowled
               << " overs "
               << "(Economy: " << economy
               << ", Maiden overs: " << bowler_maiden_overs[i]
    ...
    if (over != overs) {
      ...
      while (true) {
        ...
        cin >> bowler;
        while (bowler <= 0 || bowler > team_size) {
          cout << "Invalid choice! Please select a bowler within the range (1 "
                  "to "
               << team_size << "): ";
          cin >> bowler;
        }

        while (bowler == last_bowler) {
          cout << "This bowler cannot bowl two consecutive overs! Please "
  ...
  cout << "Innings over. Final Score: " << score << "/" << wickets
       << " (Extras: " << extras << ")" << "(Run Rate: " << run_rate << ")"
       << endl;
  cout << "\n---------- Batting Card ----------" << endl;
  for (int i = 0; i < team_size; i++) {
    double strike_rate =
        (batsman_balls[i] > 0)
            ...
            : 0.0;
    if (toss == 1 && toss_choice == 1) {
      cout << players_of_team_one[i] << ": " << batsman_scores[i] << " ("
           << batsman_balls[i] << " balls)";
    }
    if (toss == 1 && toss_choice == 2) {
      cout << players_of_team_two[i] << ": " << batsman_scores[i] << " ("
           << batsman_balls[i] << " balls)";
    }
    if (toss == 2 && toss_choice == 1) {
      cout << players_of_team_two[i] << ": " << batsman_scores[i] << " ("
  ...
  for (int i = 0; i < team_size; i++) {
    ...
    if (toss == 1 && toss_choice == 1) {
      cout << players_of_team_two[i] << ": " << bowler_runs_conceded[i]
           << " runs in " << overs_bowled << "." << balls_bowled << " overs "
           << "(Economy: " << economy
           << ", Maiden overs: " << bowler_maiden_overs[i]
           << ", Wickets: " << bowler_wickets_taken[i] << ")\n";
    }
  ...
  bool selected_batsman_innings2[team_size] = {false};

  cout << endl
       << "---------- Second Innings: Target is " << target << " ----------"
       << endl;
  ...
  string *batting_team =
      (toss == 1 && toss_choice == 1) || (toss == 2 && toss_choice == 2)
          ? players_of_team_two
          : players_of_team_one;
  string *bowling_team = (batting_team == players_of_team_two)
                             ? players_of_team_one
                             : players_of_team_two;
  string batting_team_name =
      (batting_team == players_of_team_two) ? team_name[1] : team_name[0];
  string bowling_team_name =
      (batting_team == players_of_team_two) ? team_name[0] : team_name[1];

  cout << "Select two batsmen from the following players:" << endl;
  for (int i = 0; i < team_size; i++) {
    cout << (i + 1) << ". " << batting_team[i] << endl;
  }
  cout << "Select the Opening batsman of " << batting_team_name
       << " by number: ";
  cin >> opener;
  while (opener <= 0 || opener > team_size) {
    cout << "Invalid choice! Please select a player within the range (1 to "
  ...
  selected_batsman_innings2[opener - 1] = true;
  cout << "Select the Non-Striker batsman of " << batting_team_name
       << " by number: ";
  cin >> nonstriker;
  while (nonstriker <= 0 || nonstriker > team_size) {
    cout << "Invalid choice! Please select a player within the range (1 to "
  ...
  selected_batsman_innings2[nonstriker - 1] = true;
  ...
  for (int over = 1; over <= overs; over++) {
    ...
    for (int ball = 1; ball <= 6; ball++) {
      ...
      cout << "Target: " << target << ", Runs to Win: " << runs_to_win
           << ", Balls Left: " << balls_left << endl;
      ...
      case 7:
        if (free_hit) {
          ...
          cout << "Wicket! " << batting_team[opener - 1] << " is out. ("
               << chasing_batsman_scores[opener - 1] << " runs off "
               << chasing_batsman_balls[opener - 1] << " balls)" << endl;
          ...
          cout << "Player List:" << endl;
          for (int i = 0; i < team_size; ++i) {
            cout << (i + 1) << ". " << batting_team[i];
            if (chasing_batsman_balls[i] > 0) {
              cout << " - " << chasing_batsman_scores[i] << "("
                   << chasing_batsman_balls[i] << ")";
              if (i == opener - 1) {
                cout << " OUT";
              }
            } else {
              if (selected_batsman_innings2[i]) {
                cout << " - 0(0) ";
              } else {
                cout << " - Yet to bat";
              }
          ...
          while (!valid) {
            ...
            if (new_batsman > 0 && new_batsman <= team_size &&
                chasing_batsman_balls[new_batsman - 1] == 0) {
              valid = true;
              cout << "New batsman: " << batting_team[new_batsman - 1] << endl;
              opener = new_batsman;
              selected_batsman_innings2[opener - 1] = true;
            } else {
              cout << "Invalid player choice! Please choose from available "
      ...
      cout << "Current Score: " << chasing_team_score << "/"
           << chasing_team_wickets << " (Extras: " << chasing_team_extras
           << ") (Run Rate: " << run_rate << ")" << endl;
      cout << "Batsman " << batting_team[opener - 1]
           << "*: " << chasing_batsman_scores[opener - 1] << " ("
           << chasing_batsman_balls[opener - 1] << " balls)" << endl;
      cout << "Bowler " << bowling_team[bowler - 1] << ": "
           << chasing_bowler_runs_conceded[bowler - 1] << " runs conceded in "
           << chasing_bowler_balls_bowled[bowler - 1] << " balls." << endl;
    }
    ...
    if (over != overs) {
      ...
      for (int i = 0; i < team_size; i++) {
        double economy =
            (chasing_bowler_balls_bowled[i] > 0)
                ? (static_cast<double>(chasing_bowler_runs_conceded[i]) /
                   (chasing_bowler_balls_bowled[i] / 6.0))
                : 0.0;

        cout << bowling_team[i] << ": " << chasing_bowler_runs_conceded[i]
             << " runs in " << (chasing_bowler_balls_bowled[i] / 6) << "."
             << (chasing_bowler_balls_bowled[i] % 6) << " overs "
             << "(Economy: " << economy
             << ", Maiden overs: " << chasing_bowler_maiden_overs[i]
  ...
  for (int i = 0; i < team_size; i++) {
    double strike_rate = (chasing_batsman_balls[i] > 0)
                             ? (static_cast<double>(chasing_batsman_scores[i]) /
                                chasing_batsman_balls[i]) *
                                   100
                             : 0.0;
    cout << batting_team[i] << ": " << chasing_batsman_scores[i] << " ("
         << chasing_batsman_balls[i] << " balls)";
    if (i == opener - 1 || i == nonstriker - 1) {
      cout << " *";
    }
    cout << " (Strike Rate: " << strike_rate << ")" << endl;
  ...
  string *second_innings_batting_team =
      (toss == 1 && toss_choice == 1) || (toss == 2 && toss_choice == 2)
          ? players_of_team_two
          : players_of_team_one;
  string *second_innings_bowling_team =
      (second_innings_batting_team == players_of_team_two)
          ? players_of_team_one
          : players_of_team_two;
  ...
  if (top_bowler_index != -1) {
    cout << "Top Bowler: " << second_innings_bowling_team[top_bowler_index]
         << " - " << chasing_bowler_runs_conceded[top_bowler_index]
         << " runs in " << (chasing_bowler_balls_bowled[top_bowler_index] / 6)
         << "." << (chasing_bowler_balls_bowled[top_bowler_index] % 6)
         << " overs (Economy: " << best_economy << ")" << endl;
  } else {
  ...
  for (int i = 0; i < team_size; i++) {
    ...
    if (bowler_balls_bowled[i] > 0) {
      bowler_performance = static_cast<double>(bowler_runs_conceded[i]) /
                           (bowler_balls_bowled[i] / 6.0);
    }
    ...
    if (total_performance > max_performance) {
      ...
      man_of_the_match_team = (i < team_size) ? "Team One" : "Team Two";
    }
  }

  if (man_of_the_match_index != -1) {
    string player_name = (man_of_the_match_team == "Team One")
                             ? players_of_team_one[man_of_the_match_index]
                             : players_of_team_two[man_of_the_match_index];
    cout << "Man of the Match: " << player_name << " with "
         << batsman_scores[man_of_the_match_index] << " runs and "
         << bowler_runs_conceded[man_of_the_match_index] << " runs conceded in "
         << (bowler_balls_bowled[man_of_the_match_index] / 6) << "."
         << (bowler_balls_bowled[man_of_the_match_index] % 6) << " overs."
         << endl;
  } else {
  ...
  if (toss == 1 && toss_choice == 1) {
    ...
    cout << team_name[1] << ": " << chasing_team_score << "/"
         << chasing_team_wickets << endl;
  } else if (toss == 1 && toss_choice == 2) {
    cout << team_name[1] << ": " << score << "/" << wickets << endl;
    cout << team_name[0] << ": " << chasing_team_score << "/"
         << chasing_team_wickets << endl;
  } else if (toss == 2 && toss_choice == 1) {
    cout << team_name[1] << ": " << score << "/" << wickets << endl;
    cout << team_name[0] << ": " << chasing_team_score << "/"
  ...
  if (chasing_team_score == score) {
    cout << "\nThe match is tied! Both teams scored " << score << " runs."
         << endl;
    ...
    cout << "\n"
         << ((toss == 1 && toss_choice == 1) || (toss == 2 && toss_choice == 2)
                 ? team_name[1]
                 : team_name[0])
         << " won the match by " << (team_size - chasing_team_wickets - 1)
         << " wickets!" << endl;
  } else {
    cout << "\n"
         << ((toss == 1 && toss_choice == 1) || (toss == 2 && toss_choice == 2)
                 ? team_name[0]
                 : team_name[1])
         << " won the match by " << (target - chasing_team_score - 1)
         << " runs!" << endl;
  }
  ...
  if (match_summary.is_open()) {
    ...
    match_summary << "Top Batsman: "
                  << second_innings_batting_team[top_batsman_index] << " - "
                  << top_batsman_score << " runs ("
                  << chasing_batsman_balls[top_batsman_index] << " balls)"
                  << endl;
    ...
    if (top_bowler_index != -1) {
      match_summary << "Top Bowler: "
                    << second_innings_bowling_team[top_bowler_index] << " - "
                    << chasing_bowler_runs_conceded[top_bowler_index]
                    << " runs in "
                    << (chasing_bowler_balls_bowled[top_bowler_index] / 6)
                    << "."
    ...
    if (man_of_the_match_index != -1) {
      match_summary << "Man of the Match: "
                    << second_innings_batting_team[man_of_the_match_index]
                    << " with " << (batsman_scores[man_of_the_match_index])
                    << " runs and "
                    << (bowler_runs_conceded[man_of_the_match_index])
                    << " runs conceded in "
                    << (bowler_balls_bowled[man_of_the_match_index] / 6) << "."
                    << (bowler_balls_bowled[man_of_the_match_index] % 6)
                    << " overs." << endl;
    ...
    if (toss == 1 && toss_choice == 1) {
      ...
      match_summary << team_name[1] << ": " << chasing_team_score << "/"
                    << chasing_team_wickets << endl;
    } else if (toss == 1 && toss_choice == 2) {
      match_summary << team_name[1] << ": " << score << "/" << wickets << endl;
      match_summary << team_name[0] << ": " << chasing_team_score << "/"
                    << chasing_team_wickets << endl;
    } else if (toss == 2 && toss_choice == 1) {
      match_summary << team_name[1] << ": " << score << "/" << wickets << endl;
      match_summary << team_name[0] << ": " << chasing_team_score << "/"
    ...
    if (chasing_team_score == score) {
      match_summary << "\nThe match is tied! Both teams scored " << score
                    << " runs." << endl;
    } else if (chasing_team_score >= target) {
      if (toss == 1 && toss_choice == 1) {
        match_summary << "\n"
                      << team_name[1] << " won the match by "
                      << (team_size - chasing_team_wickets - 1) << " wickets!"
                      << endl;
      } else if (toss == 1 && toss_choice == 2) {
        match_summary << "\n"
                      << team_name[0] << " won the match by "
                      << (team_size - chasing_team_wickets - 1) << " wickets!"
                      << endl;
      } else if (toss == 2 && toss_choice == 1) {
        match_summary << "\n"
      ...
      if (toss == 1 && toss_choice == 1) {
        match_summary << "\n"
                      << team_name[0] << " won the match by "
                      << (target - chasing_team_score - 1) << " runs!" << endl;
      } else if (toss == 1 && toss_choice == 2) {
        match_summary << "\n"
                      << team_name[1] << " won the match by "
                      << (target - chasing_team_score - 1) << " runs!" << endl;
